...
class GraphConvolution(Module):
    ...
    def forward(self, input, adj, activation=None):
        # input : 16x9x9
        # adj : 16x4x9x9
        # print("input shape: ", input.shape)  #qm9_16x9x5
        # print("adj shape: ", adj.shape)  #16x4x9x9
...
class GraphAggregation(Module):
    ...
    def forward(self, input, activation):
        # print("Input shape:", input.shape)  # Input shape_qm9: torch.Size([16, 9, 517])
        i = self.sigmoid_linear(input)
        # print("i shape:", i.shape)  # i shape: torch.Size([16, 55, 256])
